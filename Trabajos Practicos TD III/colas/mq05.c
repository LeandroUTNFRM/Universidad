...
//Respuestas:
// Cuando el programa recibe la señal SIGUSR1 termina.
// Cuando el programa recibe la señal SIGINT envia un mensaje a la cola de mensajes.
// Cuando el programa escribe mas de 5 mensajes, se bloquea.
