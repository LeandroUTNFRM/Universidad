...
int main(){
   ...
   switch (fork()){
      ...
      case 0:      //Hijo
         ...
         fifo_d = open(FIFO_PATH, O_RDONLY | O_NONBLOCK, 0); // O_NONBLOCK
         if(fifo_d == -1){
...
//Respuesta:
//Abriendo la fifo como no bloqueante, se puede ver que no se sincronizan los procesos
//haciendo que haya error.
