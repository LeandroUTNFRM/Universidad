...
//Respuesta:
//Ejecutando ls /tmp se puede observar el archivo MI_FIFO.
//Despues de descomentar las ultimas dos lineas de codigo, al ejecutar ls /tmp
//no se observar el archivo MI_FIFO.
